...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
            <i class="fa-solid fa-building text-blue-600"></i> Hotels / Branches
        </h2>
        ...
        <a href="{{ route('hotels.create') }}"
           class="mt-3 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 
            ...
            <i class="fa fa-plus"></i> Add New Hotel/Branch
        </a>
        @endcan
    </div>
            ...
            <table class="min-w-full border-collapse">
                <thead class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-200 text-sm uppercase">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left font-semibold">Branch Code</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    @foreach ($hotels as $hotel)
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-6 py-3 font-semibold">{{ $hotel->name }}</td>
                            <td class="px-6 py-3">{{ $hotel->branch_code }}</td>
                            <td class="px-6 py-3">{{ $hotel->address }}</td>
                            ...
                            <td class="px-6 py-3 text-center space-x-1">
                                ...
                                <form action="{{ route('hotels.destroy', $hotel->id) }}"
                                      ...
                                      onsubmit="return confirm('Are you sure you want to delete this hotel/branch?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
