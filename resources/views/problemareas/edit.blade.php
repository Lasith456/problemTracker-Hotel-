...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
            <i class="fa-solid fa-pen-to-square text-blue-600"></i> Edit Problem Area
        </h2>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 border border-gray-200 dark:border-gray-700">
        ...
        <form method="POST" action="{{ route('problem-areas.update', $area->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name"
                       value="{{ $area->name }}"
                       placeholder="Enter problem area name"
